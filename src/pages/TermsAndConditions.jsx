      ...
      <div className='bg-black border border-slate-800 text-white rounded-lg p-8 shadow-lg'>
        ...
        <div className='mb-4'>
          <ul className='list-disc list-inside '>
            ...
            <li className='mb-2'>Do not upload images greater than 10 MB.</li>
            <li className='mb-2'>
              It may take more than to 30 sec to load initial videos,
            </li>
            <li className='mb-2'>as backend is deployed on a free service.</li>
            <li className='mb-2'>
